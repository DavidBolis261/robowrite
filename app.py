...
def tweetIdeas():
    ...
    if request.method == 'POST':
        ...
        openAIAnswer = aicontent.cuteMessages(query)
        prompt = 'AI Suggestions for {} are:'.format(query)
...
def coldEmails():
    ...
    if request.method == 'POST':
        ...
        openAIAnswer = aicontent.sendEmail(query)
        prompt = 'AI Suggestions for {} are:'.format(query)
...
def socialMedia():
    ...
    if request.method == 'POST':
        ...
        openAIAnswer = aicontent.socialmediaads(query)
        prompt = 'AI Suggestions for {} are:'.format(query)
...
def businessPitch():
    ...
    if request.method == 'POST':
        ...
        openAIAnswer = aicontent.coverLetter(query)
        prompt = 'AI Suggestions for {} are:'.format(query)
...
def videoIdeas():
    ...
    if request.method == 'POST':
        ...
        openAIAnswer = aicontent.youtubeVideoIdea(query)
        prompt = 'AI Suggestions for {} are:'.format(query)
